...
<br>
<h1>Springoefeningen in zakformaat</h1>
...
<br>
De inhoud bestaat uit verschillende opstellingen van hindernissen met verschillende mogelijke lijntjes, een klein beetje praktische informatie over afstanden, een paar eenvoudige parcoursschetsen en ruimte om zelf aantekeningen te maken.<br>
Bijzonder handig zijn de flappen die je kunt uitvouwen waarop de meest gebruikte afstanden staan voor zowel pony&#39;s als paarden. </b><br>
<br>
<br>
	</td>
	</tr>
...
<br>
	...
	<tr>
	 <td colspan="2">
<br><b>Hier kunt u het boekje bestellen:</b><br>	  
...
<br>	  
	...
	<tr>
	 <td valign="top" align="left">
	  <label for="Aantal" class="required">Aantal/Anzahl<span class="required_star"> * </span></label>
	 </td>
	 <td valign="top" align="left">
	  <input type="text" name="Aantal" id="Aantal" maxlength="30" style="width:30px" >
	 </td>
	</tr>
	<tr>
	 <td valign="top" align="left">
	  <label for="Full_Name" class="required">Naam/Nahme<span class="required_star"> * </span></label>
	 </td>
	 <td valign="top" align="left">
	...
	<tr>
	 <td valign="top" align="left">
	  <label for="Adres" class="required">Adres/Adresse<span class="required_star"> * </span></label>
	 </td>
	 <td valign="top" align="left">
	...
	<tr>
	 <td valign="top" align="left">
	  <label for="Woonplaats" class="required">Woonplaats/Ort<span class="required_star"> * </span></label>
	 </td>
	 <td valign="top" align="left">
	...
	<tr>
	 <td valign="top" align="left">
	  <label for="Land" class="required">Land<span class="required_star"> * </span></label>
	 </td>
	 <td valign="top" align="left">
	  <input type="text" name="Land" id="Land" maxlength="400" style="width:400px">
	 </td>
	</tr>
	<tr>
	 <td valign="top" align="left">
